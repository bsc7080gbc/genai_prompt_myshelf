...
|-------- workflows
|------------ dataworkflow.yml                # Copies updates/data.json to root path
|------------ enforce_utf8.yml                # Create archive of updates/data.json
|------------ generate_cache_graph.yml        # Purges updates/data.json ** see note
|------------ 
